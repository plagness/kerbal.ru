...
|---|---:|---|
| Версия русификатора | **[v26.1](https://github.com/plagness/kerbal.ru/releases/tag/v26.1)** | `data/project.json` |
...
| Названия деталей | **53,9% · 551/1023** | Структурно проверенная проекция |
| Описания деталей | **71% · 726/1023** | Структурно проверенная проекция |
| Производители | **5,7% · 58/1023** | Структурно проверенная проекция |

> Активные показатели: **структурно проверенная проекция** от 2026-07-22. Последняя подтверждённая кэшем база: **36% названий / 53,7% описаний / 5,7% производителей**. [Методика и таблица по модам →](docs/COVERAGE.md)
<!-- project-data:end -->
