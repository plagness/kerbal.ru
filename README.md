...
| Названия деталей | **45,7% · 468/1023** | Подтверждено игровым кэшем |
| Описания деталей | **63,4% · 649/1023** | Подтверждено игровым кэшем |
| Производители | **5,7% · 58/1023** | Подтверждено игровым кэшем |

> Активные показатели: **подтверждено игровым кэшем** от 2026-07-22. Последняя подтверждённая кэшем база: **45,7% названий / 63,4% описаний / 5,7% производителей**. [Методика и таблица по модам →](docs/COVERAGE.md)
<!-- project-data:end -->
