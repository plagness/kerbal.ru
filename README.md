...
|---|---:|---|
| Версия русификатора | **[v26.5](https://github.com/plagness/kerbal.ru/releases/tag/v26.5)** | `data/project.json` |
| Поддерживаемые нами моды | **20** | Собственные `ru.cfg` и MM-патчи |
| Интерфейс модов | **39 словарей · 3 071 строка** | Ожидает первого живого запуска |
| Состав с русским блоком | **38 / 83 · 45,8%** | Полная инвентаризация `GameData` |
| Проверено деталей | **1 023** | `ModuleManager.ConfigCache` |
| Названия деталей | **57,6% · 589/1023** | Подтверждено игровым кэшем |
| Описания деталей | **75% · 767/1023** | Подтверждено игровым кэшем |
| Производители | **16,7% · 171/1023** | Подтверждено игровым кэшем |

> Активные показатели: **подтверждено игровым кэшем** от 2026-07-23. Последняя подтверждённая кэшем база: **57,6% названий / 75% описаний / 16,7% производителей**. [Методика и таблица по модам →](docs/COVERAGE.md)
<!-- project-data:end -->
