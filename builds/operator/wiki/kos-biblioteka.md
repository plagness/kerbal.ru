...
order: 30
related: [kos-api, kos-avtomatizaciya, kos-prodvinutoe, kos-vyvod-orbita, kos-recepty]
---
...
Точные сигнатуры всех функций — [[kos-api]]. Как это складывается в полёт от команды до орбиты — [[kos-avtomatizaciya]].
