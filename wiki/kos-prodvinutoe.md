...
order: 40
related: [kos-biblioteka, kos-recepty, krpc, avtomatika]
---
...
Когда файлов станет больше трёх, стоит развести их по модулям и оставить в миссии только цифры цели — как это устроено, в [[kos-biblioteka]].
